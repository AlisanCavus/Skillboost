...
const HireScore = () => {
  ...
  if (loading) {
    return (
      <LoaderJobDescript
        context={context}
        status={"Analysing your chances for this job description..."}
      />
    );
  }
  ...
  return (
    <WizardHeader
      p="Depends on the job description and your CV, there will be a score that you can use to assess your chances to get the job. Besides, you can find some tips to improve your CV and your chances to get the job. Evaluating your CV is a very important step to get the job you want. Please bear in mind that these assesments are generated by AI."
